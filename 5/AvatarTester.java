...
public class AvatarTester {
	...
	public void test (Avatar unit) {
		...
		int testCase = this.compareAvatars(unit, baseAvatar);
		switch (testCase){
	...
	public int compareAvatars(Avatar one, Avatar two) {
		...
		System.out.println(unitPostX);
		System.out.println(unitPostY);
		System.out.println(unitCircleX);
		System.out.println(unitCircleY);
		System.out.println(basePostX);
		System.out.println(basePostY);
		System.out.println(baseCircleX);
		System.out.println(baseCircleY);
